  ...
  return (
    <div>
      ...
      <div className="info-box-container">
        <div className="info-box-title">Assignment</div>
      ...
      <div className="info-box-container">
        <div className="info-box-title">Dates</div>
        <div className="info-box-content-container">
      ...
      <div className="info-box-container">
        <div className="info-box-title">Scores</div>
        <div className="info-box-content-container">
      ...
      <div className="info-box-container">
        <div className="info-box-title">Military Education</div>
        <div className="info-box-content-container">
          <div>
